...
import 'schema/radio_record.dart';
...
export 'schema/radio_record.dart';
export 'schema/podcast_record.dart';

/// Functions to query RadioRecords (as a Stream and as a Future).
Future<int> queryRadioRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RadioRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RadioRecord>> queryRadioRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      RadioRecord.collection,
      RadioRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RadioRecord>> queryRadioRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
