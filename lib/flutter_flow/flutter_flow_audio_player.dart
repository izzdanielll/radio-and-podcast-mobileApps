...
class _PositionSeekWidgetState extends State<PositionSeekWidget> {
  ...
  Widget build(BuildContext context) => SliderTheme(
        /// Seeks to the given [Duration] when the user finishes dragging the slider.
        ///
        /// The slider visualizes the [Duration] between [currentPosition] and
        /// [duration], allowing the user to scrub to a specific point in the audio.
        ///
        /// The slider thumb is hidden, showing only a track that fills proportionally
        /// to the [percent] completed. This customizes the slider appearance.
        ///
        /// Interaction is handled by listening to the slider's [onChangeStart],
        /// [onChangeEnd], and [onChanged] callbacks. When the user begins dragging,
        /// [listenOnlyUserInteraction] is set to true so that the [didUpdateWidget]
        /// callback does not fight the user's interactions.
